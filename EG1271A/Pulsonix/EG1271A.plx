...
(library Library_1
	...
	(patternDef "EG1271" (originalName "EG1271")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.8 -3.4) (pt 6.7 -3.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6.7 -3.4) (pt 6.7 0.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6.7 0.1) (pt -1.8 0.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.8 0.1) (pt -1.8 -3.4) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "EG1271A" (originalName "EG1271A") (compHeader (numPins 6) (numParts 1) (refDesPrefix S)
		...
		(attr "<Hyperlink>" "https://configured-product-images.s3.amazonaws.com/2D/specs/EG1271A.pdf")
		(attr "<STEP Filename>" "EG1271A.stp")
		(attr "<STEP Offsets>" "X=2.45;Y=-1.6;Z=1.42")
